...
(
   IdEstadoCuenta INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
(
   IdRegistro          INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT = 0,
...
ALTER TABLE Cuenta 			  ADD CONSTRAINT Cuenta_EstadoCuenta_FK 			FOREIGN KEY ( IdEstado ) 			 REFERENCES EstadoCuenta ( IdEstadoCuenta ) ;
